...
class BillingInfo(models.Model):
    band = models.ForeignKey(Band, verbose_name='Banda', on_delete=models.CASCADE)
    ...
    venue = models.ForeignKey(Venue, verbose_name='Escenario en el que tocaron', on_delete=models.CASCADE)
